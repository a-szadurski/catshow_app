...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left w3-black" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href='<c:url value="${pageContext.request.contextPath}/user/contestants/judges/assign"/>'
           class="w3-bar-item w3-button w3-padding">
            <i class="fa fa-fw"></i>&nbsp; Assign Cats to Judges</a>
        <a href='<c:url value="${pageContext.request.contextPath}/user/contestants/judges/view"/>'
           class="w3-bar-item w3-button w3-padding">
            <i class="fa fa-fw"></i>&nbsp; View Judges' Assigned Cats</a>
        <a href='<c:url value="${pageContext.request.contextPath}/user/contestants/manage"/>'
           class="w3-bar-item w3-button w3-padding">
            <i class="fa fa-fw"></i>&nbsp; Manage contestants</a>

        <a href='<c:url value="${pageContext.request.contextPath}/user/contestants/rate"/>'
           class="w3-bar-item w3-button w3-padding">
            <i class="fa fa-fw"></i>&nbsp; Rate Cats</a>
        <sec:authorize access="hasAnyRole('ROLE_ADMIN')">
            <a href='<c:url value="${pageContext.request.contextPath}/admin/users/add"/>'
               class="w3-bar-item w3-button w3-padding">
